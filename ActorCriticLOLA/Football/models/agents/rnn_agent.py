...
import sys, os
sys.path.insert(1, os.path.join(sys.path[0], 'models/agents'))
sys.path.append("./")
...
class RNNAgent(nn.Module):
    def __init__(self, input_shape, args, device=None):
        ...
        self.actor = Policy_net(args=(input_shape, args["n_actions"]))
        self.critic = Q_net(args=(input_shape, 1))
    ...
    def make_batch(self, data):
        ...
        obs_model, actions1, actions_onehot1, avail_u, reward_agency, obs_prime, avail_u_next, done_ = \
        ...
        return obs_model, h_in, actions1, actions_onehot1, avail_u, reward_agency, obs_prime, h_out, avail_u_next, done_
