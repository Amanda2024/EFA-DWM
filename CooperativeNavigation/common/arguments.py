...
def get_common_args():
    ...
    parser.add_argument('--alg', type=str, default='asg_vdn', help='the algorithm to train the agent')
...
def get_mixer_args(args):
    ...
    args.hyper_hidden_dim = 64  # 64
    args.qtran_hidden_dim = 64  # 64
    args.lr = 5e-4
    # args.lr = 1e-4
