...
class SSG_Q:
    def __init__(self, args):
        ...
        self.eval_parameters = list(self.eval_qmix_net.parameters()) + list(self.eval_rnn.parameters()) + list(self.eval_follower.parameters())
    ...
    def learn(self, batch, max_episode_len, train_step, epsilon=None):  # train_step表示是第几次学习，用来控制更新target_net网络的参数
        ...
        q_total_target = self.target_qmix_net(q_targets, s_next)  # (1, 50, 1)
        ...
        loss = torch.mean(masked_td_error ** 2) / mask.sum()
