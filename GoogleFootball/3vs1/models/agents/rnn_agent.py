...
class RNNAgent(nn.Module):
    ...
    def make_batch(self, data):
        ...
        state_lst_batch, state_prime_lst_batch, a_lst_batch, a1_lst_batch, avail_u_lst_batch, avail_u_next_lst_batch, r_lst_batch,r_prime_lst_batch, done_lst_batch = [], [], [], [], [], [], [], [], []
        h_in_batch, h_out_batch = [], []
        for rollout in data:  # 3
            state_lst, state_prime_lst, a_lst, a1_lst, avail_u_lst, avail_u_next_lst, r_lst,r_prime_lst, done_lst = [], [], [], [], [], [], [], [], []
            h_in_lst, h_out_lst = [], []

            for transition in rollout:
                # s, a, m, r, s_prime, prob, done, need_move = transition
                obs_model, h_in, actions1, actions_onehot1, avail_u, reward_agency, reward_agency_prime, obs_prime, h_out, avail_u_next, done = transition
            ...
            r_prime_lst_batch.append(r_prime_lst)
        ...
        obs_model, actions1, actions_onehot1, avail_u, reward_agency, reward_agency_prime,  obs_prime, avail_u_next, done_mask = \
            ...
            torch.tensor(r_prime_lst_batch, dtype=torch.float, device=self.device).permute(1, 0, 2),\
        ...
        return obs_model, h_in, actions1, actions_onehot1, avail_u, reward_agency, reward_agency_prime, obs_prime, h_out, avail_u_next, done_mask
